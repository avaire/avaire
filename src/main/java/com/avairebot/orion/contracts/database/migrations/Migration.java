package com.avairebot.orion.contracts.database.migrations;
...
public interface Migration {
     ...
     * @see com.avairebot.orion.time.Carbon
     */
    public String created_at();

    /**
     * Attempts to migrate the database, this is automatically executed from the
     * {@link com.avairebot.orion.database.migrate.Migrations#up() migrate up} method.
     *
     ...
     * {@link com.avairebot.orion.database.migrate.Migrations#down() down()} and
     * {@link com.avairebot.orion.database.migrate.Migrations#rollback(int) rollback(int)} method.
     *
     * @param schema the database schematic instance
     * @return the result of the schematic instance call
     * @throws SQLException if a database access error occurs,
