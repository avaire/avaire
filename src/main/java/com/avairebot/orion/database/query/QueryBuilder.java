...
public final class QueryBuilder {
    ...
    public Collection get() throws SQLException {
        return new com.avairebot.orion.database.collection.Collection(dbm.getConnection().query(this));
    }
    ...
    /**
     * Runs the {@link com.avairebot.orion.database.DatabaseManager#queryInsert(QueryBuilder) }
     * method with the current instance of the query builder.
     *
