...
public class SetRoleColorCommand extends Command {
    ...
    public String getDescription() {
        return "Takes in a role name, followed by a HEX value to set a role to a specific colour by simply knowing the HEX value. Additionally users can specify a random colour.";
    }
