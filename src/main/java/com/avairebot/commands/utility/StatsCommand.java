...
public class StatsCommand extends Command {
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        context.makeEmbeddedMessage(MessageType.INFO,
            new MessageEmbed.Field(context.i18n("fields.author"), "[Snow.#1726](https://sn0w.xyz/)", true),
            new MessageEmbed.Field(context.i18n("fields.website"), "[Support](https://discord.gg/jJSkd3g)", true),
            ...
            .setTitle(context.i18n("title"), "https://discord.gg/jJSkd3g")
            .setAuthor("Snows Bot v" + AppInfo.getAppInfo().version, "https://discord.gg/jJSkd3g", avaire.getSelfUser().getEffectiveAvatarUrl())
