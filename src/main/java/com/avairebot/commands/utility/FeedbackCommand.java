...
public class FeedbackCommand extends Command {
    ...
    public String getDescription() {
        return "Send feedback about abbot back to the developers and the staff team, any message passed to the command will be sent in the [#feedback](https://abbot.ml/support) channel on the [AbBot support](https://abbot.ml/support) server.";
    }
