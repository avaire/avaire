...
public class GuildController {
    ...
    private static final String[] requiredGuildColumns = new String[]{
        ...
        "guilds.local", "guilds.channels", "guilds.modules", "guilds.level_roles", "guilds.level_modifier", "guilds.claimable_roles", "guilds.prefixes",
        "guilds.aliases", "guilds.level_exempt_channels", "guilds.level_exempt_roles", "guilds.modlog_case", "guilds.modlog", "guilds.mute_role",
